...
def evaluate_test_model(model, test_loader, device, num_equipment=4, num_classes=5,  save_dir="./predictions/"):
    ...
    with torch.no_grad():
        for batch_idx, (images, activity_labels, productivity_labels) in enumerate(test_loader):
            ...
            for seq_idx in range(images.size(0)):  # Loop over the batch size (sequences)
                ...
                all_per_sequence_results_epoch7.append(per_sequence_result)
    ...
    # Save results
    results_path = os.path.join(save_dir, "per_sequence_results_epoch7.json")
    with open(results_path, "w") as f:
        json.dump(all_per_sequence_results_epoch7, f, indent=4)
...
if __name__ == "__main__":
    ...
    model_path = "/home/campus.ncl.ac.uk/nsv53/Sneha/AI in Digital Twin/Python Script/Sequential_learning/trained model/model_epoch_7.pth"
